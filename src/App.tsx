...
const GithubLinks = ({
  ...
  return (
    <div className="footer-github-link">
      ...
      <div className="footer-github-link-description">
  ...
  return (
    <div className="App">
      ...
      <div className="footer">
        <div className="footer-demo-account">Demo Account: user | 12345</div>
        <GithubLinks
          description={"Backend"}
          link={"https://github.com/noellimx/reluvate_backend"}
        />
        <GithubLinks
          description={"Frontend"}
          link={"https://github.com/noellimx/reluvate_frontend"}
        />
      </div>
    </div>
  );
